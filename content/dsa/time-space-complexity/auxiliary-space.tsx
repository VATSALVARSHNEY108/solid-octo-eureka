...
export default function AuxiliarySpaceLesson() {
  const highlights = [
    { 
      title: "Extra Memory", 
      desc: "Focuses only on the temporary variables and recursion stack used.",
      icon: <Database size={18} className="text-amber-500" />,
      bg: "rgba(245, 158, 11, 0.05)"
    },
    { 
      title: "Input Isolation", 
      desc: "Space used by input itself is ignored to analyze algorithm efficiency.",
      icon: <Target size={18} className="text-indigo-500" />,
      bg: "rgba(99, 102, 241, 0.05)"
    },
    { 
      title: "Recursion Stack", 
      desc: "Important for recursive algorithms where stack frames consume space.",
  ...
  return (
    <div style={{ fontVariantNumeric: "tabular-nums", fontFamily: "'DM Sans', sans-serif", color: "var(--text-primary)", padding: "54px" }}>
      ...
      <h2 style={{ 
        ...
        Auxiliary Space <span style={{ color: "#8b5cf6" }}></span>
      </h2>
      ...
      <MinimalSimulationStudio 
        ...
        code={["Initialize input array", "Declare temp variables", "Call recursive function", "Track depth of stack", "Deallocate variables", "Measure total temporary space"]}
      />
