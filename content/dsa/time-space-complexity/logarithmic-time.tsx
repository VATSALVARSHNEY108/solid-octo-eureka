...
export default function OlogNLogarithmicTimeLesson() {
  const highlights = [
    { 
      title: "Fast Search", 
      desc: "Extremely efficient for very large datasets.",
      icon: <Zap size={18} className="text-amber-500" />,
      bg: "rgba(245, 158, 11, 0.05)"
    },
    { 
      title: "Divide & Conquer", 
      desc: "Divide search space by 2 in every iteration.",
      icon: <Minimize size={18} className="text-indigo-500" />,
      bg: "rgba(99, 102, 241, 0.05)"
    },
    { 
      title: "Inverse Power", 
      desc: "Base-2 logarithm growth rate.",
  ...
  return (
    <div style={{ fontVariantNumeric: "tabular-nums", fontFamily: "'DM Sans', sans-serif", color: "var(--text-primary)", padding: "54px" }}>
      ...
      <h2 style={{ 
        ...
        O(log N) <span style={{ color: "#8b5cf6" }}>Logarithmic Time</span>
      </h2>
      
      <p style={{ color: "var(--text-secondary)", lineHeight: 1.7, fontSize: 15, maxWidth: 600, marginBottom: 32 }}>
        Execution time increases slowly as input grows. This usually occurs in algorithms that divide the problem space in half at each step.
      </p>
      ...
      <MinimalSimulationStudio 
        type="complexity"
        title="O(log N)"
        code={["Initialize low=0, high=N", "Calculate mid", "Discard half of space", "Repeat until found", "Steps: log2(N)"]}
      />
