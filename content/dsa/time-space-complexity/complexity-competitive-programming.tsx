...
export default function ComplexityCompetitiveProgrammingLesson() {
  const highlights = [
    { 
  ...
  return (
    <div style={{ fontVariantNumeric: "tabular-nums", fontFamily: "'DM Sans', sans-serif", color: "var(--text-primary)", padding: "54px" }}>
      ...
      <h2 style={{ 
        ...
        Complexity Competitive Programming <span style={{ color: "#8b5cf6" }}></span>
      </h2>
      ...
      <MinimalSimulationStudio 
        type="complexity"
        title="Complexity Competitive Programming"
