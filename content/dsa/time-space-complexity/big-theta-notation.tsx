...
export default function BigThetaNotationLesson() {
  const highlights = [
    { 
      title: "Tight Bound", 
      desc: "Means the Big O and Big Omega orders are the same.",
      icon: <Lock size={18} className="text-amber-500" />,
      bg: "rgba(245, 158, 11, 0.05)"
    },
    { 
      title: "Exact Growth", 
      desc: "Gives the most accurate representation of an algorithm's performance.",
      icon: <Target size={18} className="text-indigo-500" />,
      bg: "rgba(99, 102, 241, 0.05)"
    },
    { 
      title: "Sandwich Effect", 
      desc: "Algorithm growth is bounded both above and below by f(N).",
  ...
  return (
    <div style={{ fontVariantNumeric: "tabular-nums", fontFamily: "'DM Sans', sans-serif", color: "var(--text-primary)", padding: "54px" }}>
      ...
      <h2 style={{ 
        ...
        Big Theta Notation <span style={{ color: "#8b5cf6" }}></span>
      </h2>
      
      <p style={{ color: "var(--text-secondary)", lineHeight: 1.7, fontSize: 15, maxWidth: 600, marginBottom: 32 }}>
        Provides a tight bound on the growth rate, meaning the algorithm's complexity is sandwiched between a lower and upper bound of the same order.
      </p>
      ...
      <MinimalSimulationStudio 
        ...
        code={["Verify Big O = f(N)", "Verify Big Omega = f(N)", "Check constants c1, c2", "Confirm tight bound", "Express as Θ(f(N))"]}
      />
