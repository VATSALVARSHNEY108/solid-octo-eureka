...
// This is essentially identical to coin-change-i conceptually but we can present it as the classic introductory version.
interface CoinStep {
  type: string;
  amount: number;
  coinIndex: number;
...
export default function CoinChangeLesson() {
  ...
  const steps = useMemo(() => simulateCoinChange(coins, amount), [coins, amount]);
